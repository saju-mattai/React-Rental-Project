        ...
        <div className="col-6">
          ...
          <div className="float-start">
            <p className="text-start">
              Vehicle Name: {filteredData[0].Vname}
            </p>
            <p className="text-start">
            ...
            <p className="text-start ">
              Fuel Type: {filteredData[0].Vfuel}
            </p>
          </div>
          <div>
          ...
          <div className="d-flex justify-content-center mt-0  w-75 ms-5 mt-5">
            <Button className=" w-75" onClick={()=>{handleBook(filteredData[0]._id)}} variant="outlined">Book Now</Button>
            {/* </StripeCheckout> */}
          </div>
        </div>
      </div>
